...
public interface AdminAccountManagementFacingLocal {
	...
	QuotaInfo getQuotaInfoByMSISDN(AccountTrxInfo trxInfo, String billingMSISDN)
	...
	long countSearchAccount(AccountAdminTrxInfo trxInfo, String accountID, String companyName, String billingMSISDN)
			throws DBException;
}
