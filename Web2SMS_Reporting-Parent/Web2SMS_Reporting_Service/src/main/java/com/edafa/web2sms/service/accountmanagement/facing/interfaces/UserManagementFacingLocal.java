...
public interface UserManagementFacingLocal {
	...
	List<AccountUser> getAccountUsers(AccountProvTrxInfo trxInfo, List<AccountStatus> statuses)
			throws UserNotFoundException;

	AccountUser getAccountAdminUser(AccountProvTrxInfo trxInfo);

	AccountUser addAccountUser(AccountProvTrxInfo trxInfo, String username, List<AccountGroup> userGroups)
			throws DBException;

	AccountUser addAccountAdminUser(AccountProvTrxInfo trxInfo, String username, List<AccountGroup> userGroups)
	...
	AccountUser activateAdminUser(AccountProvTrxInfo trxInfo, String username, List<AccountGroup> userGroups)
			throws DBException;

	void deactivateAccountUser(AccountProvTrxInfo trxInfo, String username)
