...
@XmlType(name = "SubmittedCampaign", namespace = "http://www.edafa.com/web2sms/reporting/service/model/")
...
public class SubmittedCampaignModel {
	...
	public boolean isValid() {
		boolean result = true;
		// validate nullable
		if (campaignName == null || campaignName.isEmpty() || smsText == null || scheduleStartTimestamp == null
				|| ((individualContact == null || individualContact.isEmpty())
