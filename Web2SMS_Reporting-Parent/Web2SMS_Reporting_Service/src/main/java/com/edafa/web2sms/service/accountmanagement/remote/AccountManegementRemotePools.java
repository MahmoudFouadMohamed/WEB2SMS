...
public class AccountManegementRemotePools implements AccountManegementRemotePoolsLocal, ConfigsListener {
	...
	public void init() {
		initPools();
		configsManagerBean.registerConfigsListener(ModulesEnum.Reporting, this);
	}

	public void initPools() {

		try {
			appLogger.info("Create AccountManegementBeanRemotePool success with MaxTotal: "
					+ Configs.ACCOUNT_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue() + " and MaxIdle: "
					+ Configs.ACCOUNT_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			GenericObjectPoolConfig accountManegementBeanRemotePoolConfig = new GenericObjectPoolConfig();
			accountManegementBeanRemotePoolConfig
					.setMaxTotal((int) Configs.ACCOUNT_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue());
			accountManegementBeanRemotePoolConfig
					.setMaxIdle((int) Configs.ACCOUNT_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			accountManegementBeanRemotePool = new GenericObjectPool<AccountManegementBeanRemote>(
					new AccountManegementBeanRemoteFactory(), accountManegementBeanRemotePoolConfig);
			appLogger.info("AccountManegementBeanRemotePool created successfully with Active: "
					+ accountManegementBeanRemotePool.getNumActive() + " and Idle: "
					+ accountManegementBeanRemotePool.getNumIdle());
		...
		try {
			appLogger.info("Create AdminAccountManegementBeanRemotePool success with MaxTotal: "
					+ Configs.ACCOUNT_ADMIN_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue() + " and MaxIdle: "
					+ Configs.ACCOUNT_ADMIN_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			GenericObjectPoolConfig adminAccountManegementBeanRemotePoolConfig = new GenericObjectPoolConfig();
			adminAccountManegementBeanRemotePoolConfig
					.setMaxTotal((int) Configs.ACCOUNT_ADMIN_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue());
			adminAccountManegementBeanRemotePoolConfig
					.setMaxIdle((int) Configs.ACCOUNT_ADMIN_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			adminAccountManagementBeanRemotePool = new GenericObjectPool<AdminAccountManagementBeanRemote>(
					new AdminAccountManegementBeanRemoteFactory(), adminAccountManegementBeanRemotePoolConfig);
			appLogger.info("AdminAccountManegementBeanRemotePool created successfully with Active: "
					+ adminAccountManagementBeanRemotePool.getNumActive() + " and Idle: "
					+ adminAccountManagementBeanRemotePool.getNumIdle());
		...
		try {
			appLogger.info("Create AccountConversionBeanRemotePool success with MaxTotal: "
					+ Configs.ACCOUNT_CONVERSION_REMOTE_POOL_MAXTOTAL.getValue() + " and MaxIdle: "
					+ Configs.ACCOUNT_CONVERSION_REMOTE_POOL_MAXIDLE.getValue());
			GenericObjectPoolConfig accountConversionBeanRemotePoolConfig = new GenericObjectPoolConfig();
			accountConversionBeanRemotePoolConfig
					.setMaxTotal((int) Configs.ACCOUNT_CONVERSION_REMOTE_POOL_MAXTOTAL.getValue());
			accountConversionBeanRemotePoolConfig
					.setMaxIdle((int) Configs.ACCOUNT_CONVERSION_REMOTE_POOL_MAXIDLE.getValue());
			accountConversionBeanRemotePool = new GenericObjectPool<AccountConversionBeanRemote>(
					new AccountConversionBeanRemoteFactory(), accountConversionBeanRemotePoolConfig);
			appLogger.info("AccountConversionBeanRemotePool created successfully with Active: "
					+ accountConversionBeanRemotePool.getNumActive() + " and Idle: "
					+ accountConversionBeanRemotePool.getNumIdle());
		...
		try {
			appLogger.info("Create UserManagementBeanRemotePool success with MaxTotal: "
					+ Configs.ACCOUNT_CONVERSION_REMOTE_POOL_MAXTOTAL.getValue() + " and MaxIdle: "
					+ Configs.ACCOUNT_CONVERSION_REMOTE_POOL_MAXIDLE.getValue());
			GenericObjectPoolConfig userManagementBeanRemotePoolConfig = new GenericObjectPoolConfig();
			userManagementBeanRemotePoolConfig
					.setMaxTotal((int) Configs.ACCOUNT_USER_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue());
			userManagementBeanRemotePoolConfig
					.setMaxIdle((int) Configs.ACCOUNT_USER_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			userManagementBeanRemotePool = new GenericObjectPool<UserManagementBeanRemote>(
					new AccountUserManegementBeanRemoteFactory(), userManagementBeanRemotePoolConfig);
			appLogger.info("UserManagementBeanRemotePool created successfully with Active: "
					+ userManagementBeanRemotePool.getNumActive() + " and Idle: "
					+ userManagementBeanRemotePool.getNumIdle());
		...
		try {
			appLogger.info("Create AccountQuotaManagementBeanRemotePool success with MaxTotal: "
					+ Configs.ACCOUNT_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue() + " and MaxIdle: "
					+ Configs.ACCOUNT_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			GenericObjectPoolConfig accountQuotaManegementBeanRemotePoolConfig = new GenericObjectPoolConfig();
			accountQuotaManegementBeanRemotePoolConfig
					.setMaxTotal((int) Configs.ACCOUNT_QUOTA_MANAGEMENT_REMOTE_POOL_MAXTOTAL.getValue());
			accountQuotaManegementBeanRemotePoolConfig
					.setMaxIdle((int) Configs.ACCOUNT_QUOTA_MANAGEMENT_REMOTE_POOL_MAXIDLE.getValue());
			accountQuotaManagementBeanRemotePool = new GenericObjectPool<AccountQuotaManagementBeanRemote>(
					new AccountQuotaManegementBeanRemoteFactory(), accountQuotaManegementBeanRemotePoolConfig);
			appLogger.info("AccountQuotaManagementBeanRemotePool created successfully with Active: "
					+ accountQuotaManagementBeanRemotePool.getNumActive() + " and Idle: "
					+ accountQuotaManagementBeanRemotePool.getNumIdle());
	...
	public String getAccountManegementBeanRemotePoolData() {
		return " NumActive: " + accountManegementBeanRemotePool.getNumActive() + " ,NumIdle: "
				+ accountManegementBeanRemotePool.getNumIdle();
	}

	@Override
	public void configurationRefreshed(ModulesEnum module) {
		if (module == ModulesEnum.Reporting) {
			initPools();
		}
	}
