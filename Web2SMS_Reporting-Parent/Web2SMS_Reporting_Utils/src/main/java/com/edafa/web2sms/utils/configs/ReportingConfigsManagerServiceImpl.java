...
import com.edafa.web2sms.utils.configs.interfaces.ReportingConfigsManagerService;
import com.edafa.web2sms.utils.configs.model.ModuleConfigs;

/**
 * Session Bean implementation class AppConfigsManagerServiceImpl
 */
@Stateless(name = "ReportingConfigsManagerServiceImpl")
@LocalBean
@WebService(name = "ReportingConfigsManagerService", portName = "ReportingConfigsManagerServicePort", serviceName = "ReportingConfigsManagerService", targetNamespace = "http://www.edafa.com/ws/utils/configs", endpointInterface = "com.edafa.web2sms.utils.configs.interfaces.ReportingConfigsManagerService")
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class ReportingConfigsManagerServiceImpl implements ReportingConfigsManagerService {
	...
	public ReportingConfigsManagerServiceImpl() {}
