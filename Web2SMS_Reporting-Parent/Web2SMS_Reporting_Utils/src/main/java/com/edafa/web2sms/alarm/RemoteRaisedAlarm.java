...
public class RemoteRaisedAlarm {
	...
	public RemoteRaisedAlarm(String errorsource, int error, Severity severity, String msg, Date timestamp) {
	...
	public RemoteRaisedAlarm(String errorsource, int error, String msg) {
		this.errorsource = errorsource;
		this.error = error;
		this.msg = msg;
	}
	...
	public String toString() {
		...
		str = str.append(trxId).append(", alarmIdentifier=").append(alarmIdentifier).append(", errorsource=")
				.append(errorsource).append(", error=").append(error).append(", severity=").append(severity)
				.append(", msg=").append(msg).append(", timestamp=").append(timestamp).append('}');
		return str.toString();
	}
}
