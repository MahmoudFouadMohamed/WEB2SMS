...
public class ProvisioningEvent {
	...
	private TierModel newTier;
        ...
        public ProvisioningEvent(ProvisioningRequestInfo provisioningRequestInfo){
            this.accountId = provisioningRequestInfo.getAccountId();
            this.timestamp = provisioningRequestInfo.getTimestamp();
            this.oldStatus = provisioningRequestInfo.getOldStatus();
            this.newStatus = provisioningRequestInfo.getNewStatus();
            this.oldTier = provisioningRequestInfo.getOldTier();
            this.newTier = provisioningRequestInfo.getNewTier();
        }
