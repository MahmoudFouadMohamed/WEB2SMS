 ...
 */
@Stateless(name = "ProvConfigsManagerServiceImpl")
@LocalBean
@WebService(name = "ProvConfigsManagerService", portName = "ProvConfigsManagerServicePort", serviceName = "ProvConfigsManagerService", targetNamespace = "http://www.edafa.com/ws/utils/configs", endpointInterface = "com.edafa.web2sms.utils.configs.interfaces.ConfigsManagerService")
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class ProvConfigsManagerServiceImpl implements ConfigsManagerService {
	 ...
	 * Default constructor.
	 */
	public ProvConfigsManagerServiceImpl() {
