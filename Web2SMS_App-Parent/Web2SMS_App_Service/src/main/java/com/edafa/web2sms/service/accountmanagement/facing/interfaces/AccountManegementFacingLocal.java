...
public interface AccountManegementFacingLocal {
    ...
    public List<ActionName> checkAccountAndUserEligibility(AccountUserTrxInfo userTrxInfo) throws IneligibleAccountException, DBException;

    Account checkAccountEligibilitySMSAPI(String trxId, String accountId, ActionName userActionName, int timeOut) throws IneligibleAccountException, DBException;

    Account checkAccountEligibilitySMSAPICamp(String trxId, String accountId, ActionName userActionName, int timeOut) throws IneligibleAccountException, DBException;
    ...
    List<AccountSender> getAccountSenderList(AccountTrxInfo trxInfo, String accountId) throws NoAttachedSendersException,
            DBException;
