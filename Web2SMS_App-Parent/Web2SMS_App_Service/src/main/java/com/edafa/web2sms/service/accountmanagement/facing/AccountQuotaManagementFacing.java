...
public class AccountQuotaManagementFacing implements AccountQuotaManagementFacingLocal {
    ...
    public boolean isPrepaidQuota(AccountTrxInfo trxInfo, String msisdn) throws DBException {
        ...
        try {
            ...
            appLogger.error("Failed to get AccountQuotaManagementBeanRemote from AccountManegementRemotePoolsLocal", ex);
        }
        try {
            ...
            try {
                ...
                appLogger.error("Failed to return AccountQuotaManagementBeanRemote to AccountManegementRemotePoolsLocal", ex);
            }
        }
    ...
    public void updateReserveAccountQuota(AccountUserTrxInfo trxInfo, String campaignId, int originalCampaignQuota, int updatedCampaignQuota) throws NotPrePaidAccountException, AccountQuotaNotFoundException, InsufficientQuotaException {
        ...
        try {
            accountQuotaManagementBeanRemote.updateReserveAccountQuota(trxInfo, campaignId, originalCampaignQuota, updatedCampaignQuota);
        } finally {
            try {
                accountManegementRemotePools.returnAccountQuotaManagementBeanRemote(accountQuotaManagementBeanRemote);
