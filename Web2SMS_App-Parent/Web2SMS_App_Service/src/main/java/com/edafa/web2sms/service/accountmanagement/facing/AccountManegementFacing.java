...
public class AccountManegementFacing implements AccountManegementFacingLocal {
    ...
    public Account checkAccountEligibilitySMSAPI(String trxId, String accountId, ActionName userActionName, int timeOut) throws IneligibleAccountException, DBException {
        ...
        try {
            accountManegementBeanRemote = accountManegementRemotePools.getAccountManegementBeanRemote();
            appLogger.debug("Get AccountManegementBeanRemote from AccountManegementBeanRemotePool " + accountManegementRemotePools.getAccountManegementBeanRemotePoolData() + " Success");
        } catch (Exception e) {
            appLogger.error("Failed to get AccountManegementBeanRemote from AccountManegementBeanRemotePool", e);
        }
        try {
            account = accountManegementBeanRemote.checkAccountEligibilitySMSAPI(trxId, accountId, userActionName, timeOut);
        } finally {
            try {
                accountManegementRemotePools.returnAccountManegementBeanRemote(accountManegementBeanRemote);
            } catch (Exception e) {
    ...
    public Account checkAccountEligibilitySMSAPICamp(String trxId, String accountId, ActionName userActionName, int timeOut) throws IneligibleAccountException, DBException {
        ...
        try {
            account = accountManegementBeanRemote.checkAccountEligibilitySMSAPICamp(trxId, accountId, userActionName, timeOut);
        } finally {
            try {
                accountManegementRemotePools.returnAccountManegementBeanRemote(accountManegementBeanRemote);
            } catch (Exception e) {
