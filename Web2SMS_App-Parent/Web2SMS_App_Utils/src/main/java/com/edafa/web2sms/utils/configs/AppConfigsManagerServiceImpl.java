 ...
 */
@Stateless(name = "AppConfigsManagerServiceImpl")
@LocalBean
@WebService(name = "AppConfigsManagerService", portName = "AppConfigsManagerServicePort", serviceName = "AppConfigsManagerService", targetNamespace = "http://www.edafa.com/ws/utils/configs", endpointInterface = "com.edafa.web2sms.utils.configs.interfaces.ConfigsManagerService")
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class AppConfigsManagerServiceImpl implements ConfigsManagerService {
	 ...
	 * Default constructor.
	 */
	public AppConfigsManagerServiceImpl() {
