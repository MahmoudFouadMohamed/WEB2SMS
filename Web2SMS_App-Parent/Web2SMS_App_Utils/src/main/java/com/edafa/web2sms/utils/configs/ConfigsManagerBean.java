...
//	private RateController rateController;
	...
	public boolean isConfigurationLoaded(ModulesEnum module) {
		Boolean result1 = configuratoinLoadedFlags.get(ModulesEnum.AppUtils);
	...
	// @Override
	// public Map<String, Config> readConfigsMap(ModulesEnum module) throws
	...
	public ModuleConfigs readModuleConfigs(ModulesEnum module) throws FailedToReadConfigsException {
		...
		try {
			List<Config> configs = defaultConfigsSource.readConfigs(module.name());
	...
	public void saveConfigs(ModuleConfigs moduleConfigs) throws FailedToSaveConfigsException, InvalidConfigsException {
		...
		try {
			...
			defaultConfigsSource.saveConfigs(module.name(), configs);
