...
//		System.out.println(id);
		long diff = (System.nanoTime() - nanoTime) / 1000L;
		float timePerTrx = (float) diff / iterCount;
//		System.out.println("timediff   for info  = " + diff);
//		System.out.println("timePerTrx for info  = " + timePerTrx);
	}
