...
@Stateless
@LocalBean
@WebService(name = "SMSAPIConfigsManagerService", serviceName = "SMSAPIConfigsManagerService", targetNamespace = "http://www.edafa.com/ws/utils/configs", endpointInterface = "com.edafa.web2sms.utils.configs.interfaces.ConfigsManagerService")
@BindingType("http://schemas.xmlsoap.org/wsdl/soap/http")
public class SMSAPIConfigsManagerServiceImpl implements ConfigsManagerService {
	 ...
	 * Default constructor.
	 */
	public SMSAPIConfigsManagerServiceImpl() {
	...
	public List<ModuleConfigs> readConfigs() throws FailedToReadConfigsException {
		...
		List<ModuleConfigs> modules = configsManagerBean.readConfigs();
