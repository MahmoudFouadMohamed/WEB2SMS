 ...
 */
@Entity
@Table(name = "CAMPAIGN_SMS_STATS")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CampaignSmsStats.findAll", query = "SELECT c FROM CampaignSmsStats c"),
		@NamedQuery(name = "CampaignSmsStats.findByCampaignId", query = "SELECT c FROM CampaignSmsStats c WHERE c.campaignSmsStatsPK.campaignId = :campaignId"),
		@NamedQuery(name = "CampaignSmsStats.findByOwnerId", query = "SELECT c FROM CampaignSmsStats c WHERE c.campaignSmsStatsPK.ownerId = :ownerId") })
public class CampaignSmsStats implements Serializable {

	private static final long serialVersionUID = 654587972509012985L;

	@EmbeddedId
	protected CampaignSmsStatsPK campaignSmsStatsPK;
	...
	public CampaignSmsStats() {}

	public CampaignSmsStatsPK getCampaignSmsStatsPK() {
		return campaignSmsStatsPK;
	}

	public void setCampaignSmsStatsPK(CampaignSmsStatsPK campaignSmsStatsPK) {
		this.campaignSmsStatsPK = campaignSmsStatsPK;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((campaignSmsStatsPK == null) ? 0 : campaignSmsStatsPK.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CampaignSmsStats other = (CampaignSmsStats) obj;
		if (campaignSmsStatsPK == null) {
			if (other.campaignSmsStatsPK != null)
				return false;
		} else if (!campaignSmsStatsPK.equals(other.campaignSmsStatsPK))
			return false;
		return true;
	}
	...
	public String toString() {
		...
		builder.append("{campaignSmsStatsPK=").append(campaignSmsStatsPK).append(", vfNewSeg=").append(vfNewSeg)
