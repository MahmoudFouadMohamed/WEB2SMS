 ...
 */
@Entity
@Table(name = "COLLECTION_STATS_LIVE")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CollectionStatsLive.findAll", query = "SELECT c FROM CollectionStatsLive c"),
		@NamedQuery(name = "CollectionStatsLive.findByProcessingDate", query = "SELECT c FROM CollectionStatsLive c WHERE c.collectionStatsPK.processingDate = :processingDate"),
		@NamedQuery(name = "CollectionStatsLive.findByProcessingHour", query = "SELECT c FROM CollectionStatsLive c WHERE c.collectionStatsPK.processingHour = :processingHour"),
		@NamedQuery(name = "CollectionStatsLive.findByOwnerId", query = "SELECT c FROM CollectionStatsLive c WHERE c.collectionStatsPK.ownerId = :ownerId"),
		@NamedQuery(name = "CollectionStatsLive.findByStatsType", query = "SELECT c FROM CollectionStatsLive c WHERE c.collectionStatsPK.statsType = :statsType") })
public class CollectionStatsLive implements Serializable {

	private static final long serialVersionUID = 4253498457742955508L;
	...
	public CollectionStatsLive() {}

	public CollectionStatsLive(CollectionStatsPK collectionStatsPK) {
		this.collectionStatsPK = collectionStatsPK;
	}

	public CollectionStatsLive(Date processingDate, BigInteger processingHour, String groupId, String ownerId,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CollectionStatsLive other = (CollectionStatsLive) obj;
