...
@NamedQueries({ @NamedQuery(name = "Privilege.findAll", query = "SELECT p FROM Privilege p"),
		...
		@NamedQuery(name = "Privilege.findByHiddenFlag", query = "SELECT p FROM Privilege p WHERE p.hiddenFlag = :hiddenFlag") })
public class Privilege implements Serializable, PrivilegeConst {
	...
	public Privilege(BigDecimal privilegeId) {
		this.privilegeId = privilegeId;
	}

	public Privilege(BigDecimal privilegeId, String privilegeName) {
		this.privilegeId = privilegeId;
	...
	public void setActionList(List<Action> userActionList) {
	...
	public String toString() {
		return "com.edafa.web2sms.db.Privilege[ privilegeId=" + privilegeId + " ]";
	}
