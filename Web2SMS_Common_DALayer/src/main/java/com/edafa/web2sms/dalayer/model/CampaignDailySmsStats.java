 ...
 */
@Entity
@Table(name = "CAMPAIGN_DAILY_SMS_STATS")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CampaignDailySmsStats.findAll", query = "SELECT c FROM CampaignDailySmsStats c"),
		@NamedQuery(name = "CampaignDailySmsStats.findByProcessingDate", query = "SELECT c FROM CampaignDailySmsStats c WHERE c.campaignDailySmsStatsPK.processingDate = :processingDate"),
		@NamedQuery(name = "CampaignDailySmsStats.findByCampaignId", query = "SELECT c FROM CampaignDailySmsStats c WHERE c.campaignDailySmsStatsPK.campaignId = :campaignId"),
		@NamedQuery(name = "CampaignDailySmsStats.findByOwnerId", query = "SELECT c FROM CampaignDailySmsStats c WHERE c.campaignDailySmsStatsPK.ownerId = :ownerId") })
public class CampaignDailySmsStats implements Serializable {

	private static final long serialVersionUID = 3955918711844519706L;

	@EmbeddedId
	protected CampaignDailySmsStatsPK campaignDailySmsStatsPK;
	...
	public CampaignDailySmsStats() {}

	public CampaignDailySmsStatsPK getCampaignDailySmsStatsPK() {
		return campaignDailySmsStatsPK;
	}

	public void setCampaignDailySmsStatsPK(CampaignDailySmsStatsPK campaignDailySmsStatsPK) {
		this.campaignDailySmsStatsPK = campaignDailySmsStatsPK;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((campaignDailySmsStatsPK == null) ? 0 : campaignDailySmsStatsPK.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CampaignDailySmsStats other = (CampaignDailySmsStats) obj;
		if (campaignDailySmsStatsPK == null) {
			if (other.campaignDailySmsStatsPK != null)
				return false;
		} else if (!campaignDailySmsStatsPK.equals(other.campaignDailySmsStatsPK))
			return false;
		return true;
	}
	...
	public String toString() {
		...
		builder.append("{campaignDailySmsStatsPK=").append(campaignDailySmsStatsPK).append(", vfNewSeg=")
