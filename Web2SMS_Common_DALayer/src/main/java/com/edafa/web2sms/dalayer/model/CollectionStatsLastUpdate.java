 ...
 */
@Entity
@Table(name = "COLLECTION_STATS_LU")
@XmlRootElement
@NamedQueries({
		@NamedQuery(name = "CollectionStatsLastUpdate.findAll", query = "SELECT c FROM CollectionStatsLastUpdate c"),
		@NamedQuery(name = "CollectionStatsLastUpdate.findByProcessingDate", query = "SELECT c FROM CollectionStatsLastUpdate c WHERE c.collectionStatsPK.processingDate = :processingDate"),
		@NamedQuery(name = "CollectionStatsLastUpdate.findByProcessingHour", query = "SELECT c FROM CollectionStatsLastUpdate c WHERE c.collectionStatsPK.processingHour = :processingHour"),
		@NamedQuery(name = "CollectionStatsLastUpdate.findByOwnerId", query = "SELECT c FROM CollectionStatsLastUpdate c WHERE c.collectionStatsPK.ownerId = :ownerId"),
		@NamedQuery(name = "CollectionStatsLastUpdate.findByStatsType", query = "SELECT c FROM CollectionStatsLastUpdate c WHERE c.collectionStatsPK.statsType = :statsType") })
public class CollectionStatsLastUpdate implements Serializable {

	private static final long serialVersionUID = 7488908511999424192L;
	...
	public CollectionStatsLastUpdate() {}

	public CollectionStatsLastUpdate(CollectionStatsPK collectionStatsPK) {
		this.collectionStatsPK = collectionStatsPK;
	}

	public CollectionStatsLastUpdate(Date processingDate, BigInteger processingHour, String groupId, String ownerId,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CollectionStatsLastUpdate other = (CollectionStatsLastUpdate) obj;
