 ...
 */
@Entity
@Table(name = "CAMPAIGN_STATS_REPORT")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CampaignStatsReport.findAll", query = "SELECT c FROM CampaignStatsReport c"),
		@NamedQuery(name = "CampaignStatsReport.findByCampaignId", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.campaignId = :campaignId"),
		@NamedQuery(name = "CampaignStatsReport.findByAccountUserId", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountUserId"),
		@NamedQuery(name = "CampaignStatsReport.findByCampaignName", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignName = :campaignName"),
		@NamedQuery(name = "CampaignStatsReport.findByCreationTimestamp", query = "SELECT c FROM CampaignStatsReport c WHERE c.creationTimestamp = :creationTimestamp"),
		@NamedQuery(name = "CampaignStatsReport.findByCampaignStatus", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignStatus = :campaignStatus"),
		@NamedQuery(name = "CampaignStatsReport.findBySenderName", query = "SELECT c FROM CampaignStatsReport c WHERE c.senderName = :senderName"),
		@NamedQuery(name = "CampaignStatsReport.findBySmsText", query = "SELECT c FROM CampaignStatsReport c WHERE c.smsText = :smsText"),
		@NamedQuery(name = "CampaignStatsReport.findBySmsCount", query = "SELECT c FROM CampaignStatsReport c WHERE c.smsCount = :smsCount"),
		@NamedQuery(name = "CampaignStatsReport.findBySmsSegCount", query = "SELECT c FROM CampaignStatsReport c WHERE c.smsSegCount = :smsSegCount"),
		@NamedQuery(name = "CampaignStatsReport.findBySubmittedSmsCount", query = "SELECT c FROM CampaignStatsReport c WHERE c.submittedSmsCount = :submittedSmsCount"),
		@NamedQuery(name = "CampaignStatsReport.findBySubmittedSmsSegCount", query = "SELECT c FROM CampaignStatsReport c WHERE c.submittedSmsSegCount = :submittedSmsSegCount"),
		@NamedQuery(name = "CampaignStatsReport.findByListsCount", query = "SELECT c FROM CampaignStatsReport c WHERE c.listsCount = :listsCount"),
		@NamedQuery(name = "CampaignStatsReport.findByStartTimestamp", query = "SELECT c FROM CampaignStatsReport c WHERE c.startTimestamp = :startTimestamp"),
		@NamedQuery(name = "CampaignStatsReport.findByEndTimestamp", query = "SELECT c FROM CampaignStatsReport c WHERE c.endTimestamp = :endTimestamp"),
		@NamedQuery(name = "CampaignStatsReport.findByExecutionCount", query = "SELECT c FROM CampaignStatsReport c WHERE c.executionCount = :executionCount"),
		@NamedQuery(name = "CampaignStatsReport.findByAccountIdAndCampaignName", query = "SELECT c FROM CampaignStatsReport c WHERE LOWER(c.campaignName) = :campName AND c.campaignStatsReportPK.accountUserId = :accountId"),
		@NamedQuery(name = "CampaignStatsReport.findByAccountIdAndCampaignId", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.campaignId = :campId AND c.campaignStatsReportPK.accountUserId = :accountId"),
		@NamedQuery(name = "CampaignStatsReport.findByAccountIdAndDates", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountId AND c.startTimestamp >= :startDate AND c.startTimestamp <= :endDate"),
		@NamedQuery(name = "CampaignStatsReport.findByAccountIdAndCampNameAndDates", query = "SELECT c FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountId AND LOWER(c.campaignName) = :campName AND c.startTimestamp >= :startDate AND c.startTimestamp <= :endDate"),
		@NamedQuery(name = "CampaignStatsReport.countByAccountId", query = "SELECT count(c) FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountId "),
		@NamedQuery(name = "CampaignStatsReport.countByAccountIdAndCampName", query = "SELECT count(c) FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountId AND Lower(c.campaignName) = :campName"),
		@NamedQuery(name = "CampaignStatsReport.countByAccountIdAndDate", query = "SELECT count(c) FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountId AND c.startTimestamp >= :startDate AND c.startTimestamp<= :endDate"),
		@NamedQuery(name = "CampaignStatsReport.countByAccountIdAndCampNameAndDate", query = "SELECT count(c) FROM CampaignStatsReport c WHERE c.campaignStatsReportPK.accountUserId = :accountId AND c.startTimestamp >= :startDate AND c.startTimestamp<= :endDate AND LOWER(c.campaignName) = :campName") })
public class CampaignStatsReport implements Serializable {

	private static final long serialVersionUID = -3792890005680822588L;

	@EmbeddedId
	protected CampaignStatsReportPK campaignStatsReportPK;
	...
	public CampaignStatsReport() {}

	public CampaignStatsReportPK getCampaignStatsReportPK() {
		return campaignStatsReportPK;
	}

	public void setCampaignStatsReportPK(CampaignStatsReportPK campaignStatsReportPKPK) {
		this.campaignStatsReportPK = campaignStatsReportPKPK;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((campaignStatsReportPK == null) ? 0 : campaignStatsReportPK.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CampaignStatsReport other = (CampaignStatsReport) obj;
		if (campaignStatsReportPK == null) {
			if (other.campaignStatsReportPK != null)
				return false;
		} else if (!campaignStatsReportPK.equals(other.campaignStatsReportPK))
			return false;
		return true;
	}
	...
	public String toString() {
		...
		builder.append("{campaignStatsReportPKPK=").append(campaignStatsReportPK).append(", campaignName=")
				.append(campaignName).append(", creationTimestamp=").append(creationTimestamp)
				.append(", campaignStatus=").append(campaignStatus).append(", senderName=").append(senderName)
				.append(", smsText=").append(smsText).append(", smsCount=").append(smsCount).append(", smsSegCount=")
				.append(smsSegCount).append(", submittedSmsCount=").append(submittedSmsCount)
				.append(", submittedSmsSegCount=").append(submittedSmsSegCount).append(", listsCount=")
				.append(listsCount).append(", vfNewSeg=").append(vfNewSeg).append(", vfNewSms=").append(vfNewSms)
				.append(", vfSubmittedSeg=").append(vfSubmittedSeg).append(", vfSubmittedSms=").append(vfSubmittedSms)
				.append(", vfSentSeg=").append(vfSentSeg).append(", vfSentSms=").append(vfSentSms)
				.append(", vfTimedOutSeg=").append(vfTimedOutSeg).append(", vfTimedOutSms=").append(vfTimedOutSms)
				.append(", vfFailedToSendSeg=").append(vfFailedToSendSeg).append(", vfFailedToSendSms=")
				.append(vfFailedToSendSms).append(", vfDeliveredSeg=").append(vfDeliveredSeg)
				.append(", vfDeliveredSms=").append(vfDeliveredSms).append(", vfNotDeliveredSeg=")
				.append(vfNotDeliveredSeg).append(", vfNotDeliveredSms=").append(vfNotDeliveredSms)
				.append(", vfFailedSeg=").append(vfFailedSeg).append(", vfFailedSms=").append(vfFailedSms)
				.append(", vfReceivedSeg=").append(vfReceivedSeg).append(", vfReceivedSms=").append(vfReceivedSms)
				.append(", vfExpiredSeg=").append(vfExpiredSeg).append(", vfExpiredSms=").append(vfExpiredSms)
				.append(", vfUnknownSeg=").append(vfUnknownSeg).append(", vfUnknownSms=").append(vfUnknownSms)
				.append(", vfProcessingSeg=").append(vfProcessingSeg).append(", vfProcessingSms=")
				...
				.append(", interPartialReceivedSms=").append(interPartialReceivedSms).append(", startTimestamp=")
				.append(startTimestamp).append(", endTimestamp=").append(endTimestamp).append(", executionCount=")
				.append(executionCount).append("}");
