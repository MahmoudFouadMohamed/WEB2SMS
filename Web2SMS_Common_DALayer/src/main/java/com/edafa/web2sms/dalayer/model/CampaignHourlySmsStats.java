 ...
 */
@Entity
@Table(name = "CAMPAIGN_HOURLY_SMS_STATS")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "CampaignHourlySmsStats.findAll", query = "SELECT c FROM CampaignHourlySmsStats c"),
		@NamedQuery(name = "CampaignHourlySmsStats.findByProcessingDate", query = "SELECT c FROM CampaignHourlySmsStats c WHERE c.campaignHourlySmsStatsPK.processingDate = :processingDate"),
		@NamedQuery(name = "CampaignHourlySmsStats.findByProcessingHour", query = "SELECT c FROM CampaignHourlySmsStats c WHERE c.campaignHourlySmsStatsPK.processingHour = :processingHour"),
		@NamedQuery(name = "CampaignHourlySmsStats.findByCampaignId", query = "SELECT c FROM CampaignHourlySmsStats c WHERE c.campaignHourlySmsStatsPK.campaignId = :campaignId"),
		@NamedQuery(name = "CampaignHourlySmsStats.findByOwnerId", query = "SELECT c FROM CampaignHourlySmsStats c WHERE c.campaignHourlySmsStatsPK.ownerId = :ownerId") })
public class CampaignHourlySmsStats implements Serializable {

	private static final long serialVersionUID = -634938231219368565L;

	@EmbeddedId
	protected CampaignHourlySmsStatsPK campaignHourlySmsStatsPK;
	...
	public CampaignHourlySmsStats() {}

	public CampaignHourlySmsStatsPK getCampaignHourlySmsStatsPK() {
		return campaignHourlySmsStatsPK;
	}

	public void setCampaignHourlySmsStatsPK(CampaignHourlySmsStatsPK campaignHourlySmsStatsPK) {
		this.campaignHourlySmsStatsPK = campaignHourlySmsStatsPK;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((campaignHourlySmsStatsPK == null) ? 0 : campaignHourlySmsStatsPK.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CampaignHourlySmsStats other = (CampaignHourlySmsStats) obj;
		if (campaignHourlySmsStatsPK == null) {
			if (other.campaignHourlySmsStatsPK != null)
				return false;
		} else if (!campaignHourlySmsStatsPK.equals(other.campaignHourlySmsStatsPK))
			return false;
		return true;
	}
	...
	public String toString() {
		...
		builder.append("{campaignHourlySmsStatsPK=").append(campaignHourlySmsStatsPK).append(", vfNewSeg=")
				.append(vfNewSeg).append(", vfNewSms=").append(vfNewSms).append(", vfSubmittedSeg=")
				.append(vfSubmittedSeg).append(", vfSubmittedSms=").append(vfSubmittedSms).append(", vfSentSeg=")
				.append(vfSentSeg).append(", vfSentSms=").append(vfSentSms).append(", vfTimedOutSeg=")
				.append(vfTimedOutSeg).append(", vfTimedOutSms=").append(vfTimedOutSms).append(", vfFailedToSendSeg=")
