 ...
 */
@Entity
@Table(name = "SMSAPI_SMS_STATS")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "SmsApiSmsStats.findAll", query = "SELECT s FROM SmsApiSmsStats s"),
		@NamedQuery(name = "SmsApiSmsStats.findBySenderName", query = "SELECT s FROM SmsApiSmsStats s WHERE s.smsApiSmsStatsPK.senderName = :senderName"),
		@NamedQuery(name = "SmsApiSmsStats.findByOwnerId", query = "SELECT s FROM SmsApiSmsStats s WHERE s.smsApiSmsStatsPK.ownerId = :ownerId") })
public class SmsApiSmsStats implements Serializable {

	private static final long serialVersionUID = 8306271280149786589L;

	@EmbeddedId
	protected SmsApiSmsStatsPK smsApiSmsStatsPK;
	...
	public SmsApiSmsStats() {}

	public SmsApiSmsStatsPK getSmsApiSmsStatsPK() {
		return smsApiSmsStatsPK;
	}

	public void setSmsApiSmsStatsPK(SmsApiSmsStatsPK smsApiSmsStatsPK) {
		this.smsApiSmsStatsPK = smsApiSmsStatsPK;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((smsApiSmsStatsPK == null) ? 0 : smsApiSmsStatsPK.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SmsApiSmsStats other = (SmsApiSmsStats) obj;
		if (smsApiSmsStatsPK == null) {
			if (other.smsApiSmsStatsPK != null)
				return false;
		} else if (!smsApiSmsStatsPK.equals(other.smsApiSmsStatsPK))
			return false;
		return true;
	}
	...
	public String toString() {
		...
		builder.append("{smsApiSmsStatsPK=").append(smsApiSmsStatsPK).append(", vfNewSeg=").append(vfNewSeg)
