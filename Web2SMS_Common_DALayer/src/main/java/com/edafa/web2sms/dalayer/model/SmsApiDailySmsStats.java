 ...
 */
@Entity
@Table(name = "SMSAPI_DAILY_SMS_STATS")
@XmlRootElement
@NamedQueries({ @NamedQuery(name = "SmsApiDailySmsStats.findAll", query = "SELECT s FROM SmsApiDailySmsStats s"),
		@NamedQuery(name = "SmsApiDailySmsStats.findByProcessingDate", query = "SELECT s FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.processingDate = :processingDate"),
		@NamedQuery(name = "SmsApiDailySmsStats.findBySenderName", query = "SELECT s FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.senderName = :senderName"),
		@NamedQuery(name = "SmsApiDailySmsStats.findByOwnerId", query = "SELECT s FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.ownerId = :ownerId"),
		@NamedQuery(name = "SmsApiDailySmsStats.findByOwnerIdAndSenderAndDates", query = "SELECT s FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.ownerId = :ownerId AND s.smsApiDailySmsStatsPK.senderName = :senderName AND s.smsApiDailySmsStatsPK.processingDate >= :from and s.smsApiDailySmsStatsPK.processingDate <= :to"),
		@NamedQuery(name = "SmsApiDailySmsStats.countByOwnerIdAndSenderAndDates", query = "SELECT count(s) FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.ownerId = :ownerId AND s.smsApiDailySmsStatsPK.senderName = :senderName AND s.smsApiDailySmsStatsPK.processingDate >= :from and s.smsApiDailySmsStatsPK.processingDate <= :to"),
		@NamedQuery(name = "SmsApiDailySmsStats.findByOwnerIdAndDates", query = "SELECT s FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.ownerId = :ownerId AND s.smsApiDailySmsStatsPK.processingDate >= :from and s.smsApiDailySmsStatsPK.processingDate <= :to"),
		@NamedQuery(name = "SmsApiDailySmsStats.countByOwnerIdAndDates", query = "SELECT count(s) FROM SmsApiDailySmsStats s WHERE s.smsApiDailySmsStatsPK.ownerId = :ownerId AND s.smsApiDailySmsStatsPK.processingDate >= :from and s.smsApiDailySmsStatsPK.processingDate <= :to") })
public class SmsApiDailySmsStats implements Serializable {

	private static final long serialVersionUID = 8577865989210025863L;

	@EmbeddedId
	protected SmsApiDailySmsStatsPK smsApiDailySmsStatsPK;
	...
	public SmsApiDailySmsStats() {}

	public SmsApiDailySmsStatsPK getSmsApiDailySmsStatsPK() {
		return smsApiDailySmsStatsPK;
	}

	public void setSmsApiDailySmsStatsPK(SmsApiDailySmsStatsPK smsApiDailySmsStatsPK) {
		this.smsApiDailySmsStatsPK = smsApiDailySmsStatsPK;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((smsApiDailySmsStatsPK == null) ? 0 : smsApiDailySmsStatsPK.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SmsApiDailySmsStats other = (SmsApiDailySmsStats) obj;
		if (smsApiDailySmsStatsPK == null) {
			if (other.smsApiDailySmsStatsPK != null)
				return false;
		} else if (!smsApiDailySmsStatsPK.equals(other.smsApiDailySmsStatsPK))
			return false;
		return true;
	}
	...
	public String toString() {
		...
		builder.append("{smsApiDailySmsStatsPK=").append(smsApiDailySmsStatsPK).append(", vfNewSeg=").append(vfNewSeg)
