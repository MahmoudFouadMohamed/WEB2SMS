...
@Remote
public interface AccountManegementBeanRemote {
    ...
    Account checkAccountEligibilitySMSAPI(String trxId, String accountId, ActionName ActionName, int timeOut) throws IneligibleAccountException, DBException;

    Account checkAccountEligibilitySMSAPICamp(String trxId, String accountId, ActionName ActionName, int timeOut) throws IneligibleAccountException, DBException;
