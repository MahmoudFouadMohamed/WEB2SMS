...
public class AlarmRasingBean implements com.edafa.jee.apperr.alarm.AlarmRasingBean {
    ...
    Logger logger = LogManager.getLogger(LoggersEnum.ACCOUNT_MNGMT_UTILS.name());
    ...
    public void raiseAlarm(Alarm appError) {
        String alarmingIdentifier = (String) Configs.ACCOUNT_MANAGEMENT_ALARMING_IDENTIFIER.getValue();
